    ...
    try {
      ...
      const generateButtons = (index: number) => [
        new ActionRowBuilder<ButtonBuilder>().addComponents(
          new ButtonBuilder().setCustomId("first").setLabel("⏪").setStyle(ButtonStyle.Secondary).setDisabled(index === 0),
          new ButtonBuilder().setCustomId("prev").setLabel("⬅").setStyle(ButtonStyle.Secondary).setDisabled(index === 0),
          new ButtonBuilder().setCustomId("next").setLabel("➡").setStyle(ButtonStyle.Secondary).setDisabled(index === results.length - 1),
          new ButtonBuilder().setCustomId("last").setLabel("⏩").setStyle(ButtonStyle.Secondary).setDisabled(index === results.length - 1)
        ),
        new ActionRowBuilder<ButtonBuilder>().addComponents(
          new ButtonBuilder().setCustomId("reminder_dm").setLabel("🔔 DM Me").setStyle(ButtonStyle.Primary),
          new ButtonBuilder().setCustomId("reminder_channel").setLabel("🔔 This Channel").setStyle(ButtonStyle.Primary),
          new ButtonBuilder().setCustomId("reminder_event").setLabel("📅 Create Event").setStyle(ButtonStyle.Success)
        )
      ];
